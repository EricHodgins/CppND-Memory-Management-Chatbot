...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            _edges.emplace_back(std::unique_ptr<GraphEdge>(new GraphEdge(id)));
    ...
    std::cout << "Root node has: " << rootNode->GetNumberOfChildEdges() << " child edges " << std::endl;
...
{
    std::cout << "SendMessageToChatbot: " << _chatBot << std::endl;
